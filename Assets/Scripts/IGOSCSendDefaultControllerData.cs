...
namespace UniOSC{
	...
	/// </summary>
	[AddComponentMenu("UniOSC/IGOSCSendDefaultControllerData")]
	[ExecuteInEditMode]
	public class IGOSCSendDefaultControllerData: UniOSCEventDispatcher {
		...
		public void SendOSCMessageDown(){
			_OSCeArg.Message.UpdateDataAt(0,downOSCDataValue);
		...
		public void SendOSCMessageUp(){
			_OSCeArg.Message.UpdateDataAt(0,upOSCDataValue);
			_SendOSCMessage(_OSCeArg);
		}
