...
namespace UniOSC{
	...
	public class UniOSCEventTargetEditor : Editor {
		...
		public virtual void OnEnable () {
			...
			ReceiveAllAddressesProp = serializedObject.FindProperty ("receiveAllAddresses");
			ReceiveAllPortsProp = serializedObject.FindProperty ("receiveAllPorts");
			OSCAddressProp = serializedObject.FindProperty ("oscAddress");
			OSCPortProp  = serializedObject.FindProperty ("oscPort");

			UseExplicitConnectionProp = serializedObject.FindProperty("useExplicitConnection");
			ExplicitConnectionProp = serializedObject.FindProperty("explicitConnection");
