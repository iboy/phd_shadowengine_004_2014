...
public class UniOSCClassBasedDemo : MonoBehaviour {
	...
	{
		Debug.Log("UniOSCCodeBasedDemo.OnOSCMessageReceived1:"+args.Message.Address);
		if(Light1 != null) Light1.enabled = !  Light1.enabled ;
	}

	void OnOSCMessageReceived2(object sender, UniOSCEventArgs args)
	{
		Debug.Log("UniOSCCodeBasedDemo.OnOSCMessageReceived2:"+args.Message.Address);
	...
	void OnOSCMessageReceived4(object sender, UniOSCEventArgs args){
		Debug.Log("UniOSCCodeBasedDemo.OnOSCMessageReceived4:"+args.Message.Address);
	}
